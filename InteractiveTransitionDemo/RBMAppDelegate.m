...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UINavigationController *_rootNavigationController = [[UINavigationController alloc] init];
    _rootNavigationController.navigationBar.hidden = YES;
    _rootNavigationController.view.frame = [[UIScreen mainScreen] bounds];

    RBMMainVC *rootVC = [[RBMMainVC alloc] init];

    _rootNavigationController.delegate = rootVC;

    [_rootNavigationController pushViewController:  rootVC animated:NO];
